        ...
        <footer className="footerContainer">
            <div>
                <Text>Travel2it is coded by <a className="footer-link" target="_blank" href='https://www.linkedin.com/in/sara-baqla/' title="Sara, a linkedin.com link">Sara
                    ...
                    </a>: See our project on <a className="footer-link" target="_blank" href='https://github.com/chingu-voyages/v41-geckos-team-09' title="the Travel 2 It Github link">Github <em></em>
